...
## Introduction  
This is my introduction paragraph right here is my intro
...
```{r state_map1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=12, fig.cap="**Figure 1:** A comparison of the number of total cases across the state of Michigan by week."}
...
`{r weekly_county_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig.cap="**Figure 2:** A comparison of the number of total cases in Bay, Saginaw, and Midland counties by week. The bars indicate total daily cases and the lines are four-week moving averages. "}
...
ggplot(counties, aes(x=Date, y=Cases, color=County, fill=County)) +
  scale_color_manual(values=c('isabella'="firebrick", 'mecosta'="dodgerblue", 'ottawa'="steelblue")) +
  scale_fill_manual(legend, values=c('isabella'="firebrick", 'mecosta'="dodgerblue", 'ottawa'="steelblue")) +
  scale_x_datetime(breaks = date_breaks("months"),labels = date_format("%b")) +
  geom_bar(stat = "identity") +
  geom_ma(ma_fun = EMA, n = 7, wilder = TRUE, linetype = 1, size = 2) +
  geom_vline(xintercept = as.POSIXct(as.Date(c("2020-07-04", "2020-08-17", "2020-08-31", "2020-09-07"))), linetype=4) +
