...
```{r state_plot2, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=12, fig.cap="**Figure 1:** A comparison of the number of deaths and cases across the state of Michigan by week and by region."}
