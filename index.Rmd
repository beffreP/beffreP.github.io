...
```{r county_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig.cap="**Figure 2:** A comparison of the number of total cases in Bay, Saginaw, and Midland counties by week. The bars indicate toal daily cases and the lines are four-week moving averages."}
