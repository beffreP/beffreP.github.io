...
## Introduction  
The data throughout this report will provide you with knowledge on COVID-19 cases across the state of Michigan. A comparison can be made between COVID-19 and the different counties within the state of Michigan. Total deaths across the state and in each county they occurred in can also be identified.
...
```{r state_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig. cap="**Figure 2:** The amount of cases in the entire state of Michigan, reported monthly"}
...
## Comparing Counties
 description
```{r weekly_county_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig.cap="**Figure 3:** "}
...
```{r weekly_county_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig.cap="**Figure 4:** A comparison of the number of total cases in Isabella, Mecosta, and Ottawa counties by week. The bars indicate total daily cases and the lines are four-week moving averages." }
counties <- weekly %>% 
